...
<section id="organizadores">
    <div class="container">
        <div class="row posiciona">
            ...
            <img class="" src="{{asset('images/organizadores/organizadores.jpg')}}">
			<img id="colaboradorResalta" class="imgEncima invisible" src="{{asset('images/organizadores/musicasCompleto.png')}}">
			<img class="imgEncima" src="{{asset('images/organizadores/frenteOrganiza.png')}}" alt="" usemap="#mapaOrganizadores" />
		</div>
    </div>
</section>
<script>
