...
<!--            <div class="custom-navigation col-md-12">
                <div class="col-md-9">
                    <a href="#" class="flex-prev anteriorVideo"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
                </div>
                div class="custom-controls-container"></div
                <div class="col-md-3">
                    <a href="#" class="flex-next siguienteVideo"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </div>
            </div>-->
